...
dead_rising_deluxe_remaster_location = {}
dead_rising_deluxe_remaster_location.__index = dead_rising_deluxe_remaster_location
...
function dead_rising_deluxe_remaster_location.new(name)
    local self = setmetatable({}, dead_rising_deluxe_remaster_location)
    if name then
...
function dead_rising_deluxe_remaster_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = dead_rising_deluxe_remaster_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function dead_rising_deluxe_remaster_location:connect_two_ways(exit, rule)
...
function dead_rising_deluxe_remaster_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function dead_rising_deluxe_remaster_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function dead_rising_deluxe_remaster_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function dead_rising_deluxe_remaster_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function dead_rising_deluxe_remaster_location:accessibility()
...
-- 
function dead_rising_deluxe_remaster_location:discover(accessibility, keys)
...
entry_point = dead_rising_deluxe_remaster_location.new("entry_point")
