...
local pp_bonus_locations_enabled = nil
local enable_skill_items_enabled = nil
...
Archipelago:AddClearHandler("dead_rising_slot_data_init", function(slot_data)
    ...
    -- PP Bonus
    local pp_val = slot_data.pp_bonus_locations
    if pp_val == nil and slot_data.options then pp_val = slot_data.options.pp_bonus_locations end
    pp_bonus_locations_enabled = (pp_val == true or pp_val == 1)
    print("PP Bonus Locations: " .. (pp_bonus_locations_enabled and "ENABLED" or "DISABLED"))

    -- Skill Items
    local sk_val = slot_data.enable_skill_items
    if sk_val == nil and slot_data.options then sk_val = slot_data.options.enable_skill_items end
    enable_skill_items_enabled = (sk_val == true or sk_val == 1)
    print("Skill Items: " .. (enable_skill_items_enabled and "ENABLED" or "DISABLED"))
    ...
    if goal_val == 1 then
        current_goal = "ending_a"
        print(">>> GOAL IS ENDING A")
    elseif goal_val == 2 then
        current_goal = "savior"
        print(">>> GOAL IS SAVIOR")
    else
        current_goal = "ending_s"
        print(">>> GOAL IS ENDING S (default)")
    end
...
function hasPPBonus()    return pp_bonus_locations_enabled and 1 or 0 end
function hasSkillItems()    return enable_skill_items_enabled and 1 or 0 end
function hasNoSkills()    return (not enable_skill_items_enabled) and 1 or 0 end
...
function hasGoalEndingA()
    return (current_goal == "ending_a") and 1 or 0
end

function hasGoalEndingS()
    return (current_goal == "ending_s") and 1 or 0
end

function hasGoalSavior()
    return (current_goal == "savior") and 1 or 0
end
...
local SCOOP_TO_PATH = {
    ...
    ["Medicine Run"]                = "@Main Scoops/Medicine Run/Obtain First Aid Kit",
...
function hasParadiseAccess()
    return Tracker:ProviderCountForCode("rooftopkey") > 0 and
           Tracker:ProviderCountForCode("warehousekey") > 0 and
...
function hasLeisureAccess()
    ...
    if Tracker:ProviderCountForCode("rooftopkey") > 0 and
       ...
       Tracker:ProviderCountForCode("leisureparkkey") > 0 then
        return 1
    end
    -- Path 2: ScoopSanity alternative
    ...
    -- Path 3: Alternative tunnel access scoopsanity
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasTunnelAccess()
    ...
    -- Path 3: Alternative scoopsanity tunnel access via Entrance
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 4: Alternative scoopsanity tunnel access via Entrance and ground
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasFoodAccess()
    ...
    -- Path 3: ScoopSanity alternative via Entrance
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 4: ScoopSanity alternative via Entrance and tunnel
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasNorthAccess()
    ...
    -- Path 4: ScoopSanity alternative via Entrance
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 5: ScoopSanity alternative via Entrance and tunnel through grocery
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 6: ScoopSanity alternative via Entrance and tunnel through Wonderland
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 7: ScoopSanity alternative via Entrance and tunnel through Leisure
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasCrislipsAccess()
    ...
    -- Path 5: ScoopSanity alternative via tunnel and Wonderland
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 6: ScoopSanity alternative via tunnel and Grocery
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
    ...
    -- Path 7: ScoopSanity alternative via tunnel and Leisure
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasGroceryAccess()
    ...
    -- Path 5: ScoopSanity alternative via tunnel
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
...
function hasWonderlandAccess()
    ...
    -- Path 6: ScoopSanity alternative via tunnel
    if hasScoopSanity() == 1 and
       Tracker:ProviderCountForCode("rooftopkey") > 0 and
       Tracker:ProviderCountForCode("warehousekey") > 0 and
       Tracker:ProviderCountForCode("entranceplazakey") > 0 and
